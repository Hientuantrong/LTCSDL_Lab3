...
namespace Lab3_ThucHanh
{
    public partial class frmSinhVien : Form
    {
        ...
        private void butXoa_Click(object sender, EventArgs e)
        {
            ...
            for (i = count; i >= 0; i--)
            {
                lvtiem = this.lvSinhVien.Items[i];
                if (lvtiem.Checked)
                    qlsv.Xoa(lvtiem.SubItems[0].Text, SoSanhTheoMa);
            }
            this.LoadListView();
        ...
        private void mniSapXep_Click(object sender, EventArgs e)
        {
            frmTuyChon dialog = new frmTuyChon();
            dialog.ShowDialog();
        }

        private void mniMoFile_Click(object sender, EventArgs e)
        {
            OpenFileDialog dlg = new OpenFileDialog();
            dlg.Title = "Select Picture";
            dlg.Filter = "Image Files (JPEG, GIF, BMP, etc.)|"
        ...
        private void mniThem_Click(object sender, EventArgs e)
        {
            SinhVien sv = GetSinhVien();
            SinhVien kq = qlsv.Tim(sv.MaSo, SoSanhTheoMa);
            if (kq != null)
        ...
        private void mniForn_Click(object sender, EventArgs e)
        {
        ...
        private void mniMauChu_Click(object sender, EventArgs e)
        {
            ColorDialog MauChu = new ColorDialog();

            if (MauChu.ShowDialog() == DialogResult.OK)
                lvSinhVien.ForeColor = MauChu.Color;
        }
    }
}
